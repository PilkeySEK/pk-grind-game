...
execute if items entity @s player.cursor *[custom_data~{play_pk:true}] run function core:player/item_click/play_pk
execute if items entity @s player.cursor *[custom_data~{goto_spawn:true}] run function core:player/item_click/goto_spawn
