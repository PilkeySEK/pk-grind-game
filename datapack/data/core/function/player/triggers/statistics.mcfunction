...
tellraw @s [{text:"Server uptime this session: ",color:"gold"},\
    ...
    {score:{name:"pad_minutes",objective:"tmp"},color:"dark_aqua"},{score:{name:"minutes",objective:"tmp"},color:"dark_aqua"},{text:":",color:"dark_green"},\
    {score:{name:"pad_seconds",objective:"tmp"},color:"dark_aqua"},{score:{name:"seconds",objective:"tmp"},color:"dark_aqua"},{text:":",color:"dark_green"},\
