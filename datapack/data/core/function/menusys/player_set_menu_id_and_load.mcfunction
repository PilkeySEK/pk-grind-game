...
execute as @e[type=chest_minecart,tag=inventory] if score @s inventory_id = .this inventory_id run scoreboard players operation @e[type=chest_minecart,tag=inventory,tag=this.minecart] menu_id = .id menu_id
