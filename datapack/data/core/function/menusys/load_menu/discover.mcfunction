data modify entity @s Items set value [\
    ...
    {Slot:13b,id:"minecraft:green_concrete",count:1,components:{custom_data:{inv_item:tru,inv_click:true,show_medium_pks:true},item_name:{text:"Medium",color:"gold"},lore:[{text:"Required level: ",color:"aqua",italic:false},{score:{name:"medium_pks",objective:"required_level"},color:"light_purple"}]}},\
    {Slot:15b,id:"minecraft:green_concrete",count:1,components:{custom_data:{inv_item:tru,inv_click:true,show_hard_pks:true},item_name:{text:"Hard",color:"gold"},lore:[{text:"Required level: ",color:"aqua",italic:false},{score:{name:"hard_pks",objective:"required_level"},color:"light_purple"}]}}\
]
